...
public class StudentHomePresenter extends BasePresenter<StudentHomeView> {
    ...
    public void getInfoWithTeacherList() {
        ...
        ApiHandler.getApiService().getStudentDashBorad(getInfo(), new Callback<StudentDashboardMainInfo>() {
            @Override
            public void success(StudentDashboardMainInfo studentDashboardMainInfo, Response response) {
                getMvpView().hideProgressDialog();
                getMvpView().showSlider(studentDashboardMainInfo.getData());
                getMvpView().showTeacherList(studentDashboardMainInfo.getTeacherInfo());
            }
...
//        });
    ...
    public HashMap<String, String> getInfo() {
        ...
        hashMap.put(RequestParams.Role.getValue(), "student");
